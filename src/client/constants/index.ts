// COLORS
export const CORRECT_COLOR: string = '#0b8c34';
export const WRONG_POSITION_COLOR: string = '#946f00';
export const INCORRECT_COLOR: string = '#5e5e5e';

// SETTINGS
export const MAX_GUESSES: number = 5;
